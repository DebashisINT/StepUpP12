...
import com.breezefsmp12.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefsmp12.features.billing.api.AddBillingRepoProvider
import com.breezefsmp12.features.billing.model.AddBillingInputParamsModel
...
import com.breezefsmp12.features.dashboard.presentation.ReasonDialog
...
import com.breezefsmp12.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefsmp12.features.nearbyshops.model.updateaddress.AddressUpdateRequest
...
import com.breezefsmp12.features.orderhistory.model.*
...
import com.breezefsmp12.features.quotation.model.AddQuotInputModel
import com.breezefsmp12.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmp12.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
...
import com.breezefsmp12.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefsmp12.features.timesheet.model.AddTimeSheetInputModel
...
import com.breezefsmp12.features.returnsOrder.ReturnRequest
import com.breezefsmp12.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmp12logsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmp12logsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmp12logsample/log.zip").path);
