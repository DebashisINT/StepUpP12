...
import com.breezefsmp12.*
import com.breezefsmp12.R
import com.breezefsmp12.app.*
import com.breezefsmp12.app.NewFileUtils.browseDocuments
import com.breezefsmp12.app.NewFileUtils.browsePDFDocuments
import com.breezefsmp12.app.NewFileUtils.getExtension
import com.breezefsmp12.app.domain.*
import com.breezefsmp12.app.types.DashboardType
import com.breezefsmp12.app.types.FragType
import com.breezefsmp12.app.types.TopBarConfig
import com.breezefsmp12.app.uiaction.DisplayAlert
import com.breezefsmp12.app.utils.*
import com.breezefsmp12.app.utils.AppUtils.Companion.isProfile
...
import com.breezefsmp12.features.NewQuotation.*
import com.breezefsmp12.features.NewQuotation.api.GetQuotRegProvider
import com.breezefsmp12.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefsmp12.features.SearchLocation.SearchLocationFragment
import com.breezefsmp12.features.SearchLocation.locationInfoModel
import com.breezefsmp12.features.TA.ViewAllTAListFragment
import com.breezefsmp12.features.achievement.AchievementFragment
import com.breezefsmp12.features.activities.presentation.*
import com.breezefsmp12.features.addAttendence.*
import com.breezefsmp12.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefsmp12.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefsmp12.features.addAttendence.model.GetReportToFCMResponse
import com.breezefsmp12.features.addAttendence.model.GetReportToResponse
import com.breezefsmp12.features.addAttendence.model.Leave_list_Response
import com.breezefsmp12.features.addorder.presentation.AddOrderFragment
...
import com.breezefsmp12.features.addshop.presentation.AddShopFragment
import com.breezefsmp12.features.addshop.presentation.OTPVerificationDialog
import com.breezefsmp12.features.addshop.presentation.ScanImageFragment
import com.breezefsmp12.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefsmp12.features.alarm.model.AlarmData
import com.breezefsmp12.features.alarm.presetation.AttendanceReportFragment
import com.breezefsmp12.features.alarm.presetation.PerformanceReportFragment
import com.breezefsmp12.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefsmp12.features.alarm.presetation.VisitReportFragment
import com.breezefsmp12.features.attendance.AttendanceFragment
import com.breezefsmp12.features.attendance.api.AttendanceRepositoryProvider
import com.breezefsmp12.features.attendance.model.AttendanceRequest
import com.breezefsmp12.features.attendance.model.AttendanceResponse
import com.breezefsmp12.features.averageshop.presentation.AverageShopFragment
import com.breezefsmp12.features.avgorder.presentation.AverageOrderFragment
import com.breezefsmp12.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefsmp12.features.beatCustom.TeamBeatListFragment
import com.breezefsmp12.features.billing.presentation.AddBillingFragment
import com.breezefsmp12.features.billing.presentation.BillingDetailsFragment
import com.breezefsmp12.features.billing.presentation.BillingListFragment
import com.breezefsmp12.features.changepassword.presentation.ChangePasswordDialog
import com.breezefsmp12.features.chat.model.ChatListDataModel
import com.breezefsmp12.features.chat.model.ChatUserDataModel
import com.breezefsmp12.features.chat.model.GroupUserDataModel
import com.breezefsmp12.features.chat.presentation.*
import com.breezefsmp12.features.chatbot.presentation.ChatBotFragment
import com.breezefsmp12.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefsmp12.features.chatbot.presentation.ReportsFragment
import com.breezefsmp12.features.chatbot.presentation.SelectLanguageDialog
...
import com.breezefsmp12.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefsmp12.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefsmp12.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefsmp12.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefsmp12.features.contacts.ContactDtls
import com.breezefsmp12.features.contacts.ContactGr
import com.breezefsmp12.features.contacts.ContactsAddFrag
import com.breezefsmp12.features.contacts.ContactsFrag
import com.breezefsmp12.features.contacts.SchedulerViewFrag
import com.breezefsmp12.features.contacts.SchedulerAddFormFrag
import com.breezefsmp12.features.contacts.TemplateAddFrag
import com.breezefsmp12.features.contacts.TemplateViewFrag
import com.breezefsmp12.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefsmp12.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefsmp12.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefsmp12.features.damageProduct.ShopDamageProductListFrag
import com.breezefsmp12.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefsmp12.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefsmp12.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefsmp12.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefsmp12.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefsmp12.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefsmp12.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefsmp12.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefsmp12.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefsmp12.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefsmp12.features.device_info.presentation.DeviceInfoListFragment
import com.breezefsmp12.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefsmp12.features.document.DocumentRepoFeatureNewFragment
import com.breezefsmp12.features.document.presentation.DocumentListFragment
import com.breezefsmp12.features.document.presentation.DocumentTypeListFragment
import com.breezefsmp12.features.document.presentation.OpenFileWebViewFragment
import com.breezefsmp12.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefsmp12.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefsmp12.features.dymanicSection.presentation.DynamicListFragment
import com.breezefsmp12.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefsmp12.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefsmp12.features.home.presentation.HomeFragment
import com.breezefsmp12.features.homelocation.presentation.HomeLocationFragment
import com.breezefsmp12.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefsmp12.features.know_your_state.KnowYourStateFragment
import com.breezefsmp12.features.lead.LeadFrag
import com.breezefsmp12.features.lead.ViewLeadFrag
import com.breezefsmp12.features.leaveapplynew.LeaveHome
import com.breezefsmp12.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefsmp12.features.localshops.LocalShopListFragment
import com.breezefsmp12.features.localshops.LocalShopListMapFragment
import com.breezefsmp12.features.localshops.NearByShopsMapFragment
import com.breezefsmp12.features.location.*
import com.breezefsmp12.features.location.api.LocationRepoProvider
...
import com.breezefsmp12.features.login.ShopFeedbackEntity
import com.breezefsmp12.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefsmp12.features.login.presentation.LoginActivity
import com.breezefsmp12.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefsmp12.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefsmp12.features.marketAssist.MarketAssistTabFrag
import com.breezefsmp12.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefsmp12.features.marketAssist.ShopListMarketAssistFrag
import com.breezefsmp12.features.marketing.presentation.MarketingPagerFragment
import com.breezefsmp12.features.meetinglist.prsentation.MeetingListFragment
import com.breezefsmp12.features.member.MapViewForTeamFrag
import com.breezefsmp12.features.member.model.TeamLocDataModel
import com.breezefsmp12.features.member.model.TeamShopListDataModel
import com.breezefsmp12.features.member.presentation.*
import com.breezefsmp12.features.menuBeat.MenuBeatFrag
import com.breezefsmp12.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefsmp12.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefsmp12.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefsmp12.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefsmp12.features.myjobs.model.CustomerDataModel
import com.breezefsmp12.features.myjobs.presentation.*
import com.breezefsmp12.features.myorder.presentation.MyOrderListFragment
import com.breezefsmp12.features.myprofile.presentation.MyProfileFragment
...
import com.breezefsmp12.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefsmp12.features.nearbyshops.presentation.BeatListFragment
import com.breezefsmp12.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefsmp12.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefsmp12.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefsmp12.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefsmp12.features.newcollection.CollectionDetailsStatusFragment
import com.breezefsmp12.features.newcollection.CollectionShopListFragment
import com.breezefsmp12.features.newcollection.NewCollectionListFragment
import com.breezefsmp12.features.newcollectionreport.*
import com.breezefsmp12.features.notification.NotificationFragment
import com.breezefsmp12.features.orderList.NewDateWiseOrderListFragment
import com.breezefsmp12.features.orderList.NewOrderListFragment
import com.breezefsmp12.features.orderList.OrderListFragment
import com.breezefsmp12.features.orderdetail.presentation.OrderDetailFragment
import com.breezefsmp12.features.orderhistory.ActivityMapFragment
import com.breezefsmp12.features.orderhistory.OrderhistoryFragment
import com.breezefsmp12.features.orderhistory.TimeLineFragment
...
import com.breezefsmp12.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefsmp12.features.performance.GpsStatusFragment
import com.breezefsmp12.features.performance.PerformanceFragment
import com.breezefsmp12.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefsmp12.features.performance.model.UpdateGpsInputParamsModel
import com.breezefsmp12.features.performanceAPP.OwnPerformanceFragment
import com.breezefsmp12.features.performanceAPP.PerformanceAppFragment
import com.breezefsmp12.features.performanceAPP.allPerformanceFrag
import com.breezefsmp12.features.permissionList.ViewPermissionFragment
import com.breezefsmp12.features.photoReg.*
import com.breezefsmp12.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefsmp12.features.quotation.presentation.*
import com.breezefsmp12.features.reimbursement.presentation.*
import com.breezefsmp12.features.report.presentation.*
import com.breezefsmp12.features.returnsOrder.*
import com.breezefsmp12.features.settings.presentation.SettingsFragment
import com.breezefsmp12.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefsmp12.features.shopdetail.presentation.*
import com.breezefsmp12.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmp12.features.stock.StockDetailsFragment
import com.breezefsmp12.features.stock.StockListFragment
import com.breezefsmp12.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefsmp12.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefsmp12.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefsmp12.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefsmp12.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefsmp12.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefsmp12.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefsmp12.features.survey.SurveyFrag
import com.breezefsmp12.features.survey.SurveyViewDtlsFrag
import com.breezefsmp12.features.survey.SurveyViewFrag
import com.breezefsmp12.features.task.presentation.AddTaskFragment
import com.breezefsmp12.features.task.presentation.CalenderTaskFragment
import com.breezefsmp12.features.task.presentation.EditTaskFragment
import com.breezefsmp12.features.task.presentation.TaskListFragment
import com.breezefsmp12.features.taskManagement.TaskManagementFrag
import com.breezefsmp12.features.taskManagement.ViewTaskManagementFrag
import com.breezefsmp12.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefsmp12.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefsmp12.features.timesheet.presentation.TimeSheetListFragment
import com.breezefsmp12.features.viewAllOrder.CartFragment
import com.breezefsmp12.features.viewAllOrder.OrderTypeListFragment
import com.breezefsmp12.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefsmp12.features.viewAllOrder.ViewCartFragment
import com.breezefsmp12.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefsmp12.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefsmp12.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefsmp12.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefsmp12.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefsmp12.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefsmp12.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefsmp12.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefsmp12.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefsmp12.features.viewPPDDStock.ViewStockFragment
import com.breezefsmp12.features.weather.presentation.WeatherFragment
import com.breezefsmp12.mappackage.MapActivity
import com.breezefsmp12.mappackage.MapActivityWithoutPath
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefsmp12logsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmp12logsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefsmp12/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmp12logsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmp12logsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmp12logsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmp12logsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
