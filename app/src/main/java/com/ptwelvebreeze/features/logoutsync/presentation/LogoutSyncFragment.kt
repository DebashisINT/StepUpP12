package com.ptwelvebreeze.features.logoutsync.presentation
...
import com.ptwelvebreeze.app.AppDatabase
...
import com.ptwelvebreeze.app.utils.AppUtils
import com.ptwelvebreeze.app.utils.Toaster
import com.ptwelvebreeze.base.BaseResponse
import com.ptwelvebreeze.base.presentation.BaseActivity
import com.ptwelvebreeze.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.ptwelvebreeze.features.billing.api.AddBillingRepoProvider
import com.ptwelvebreeze.features.billing.model.AddBillingInputParamsModel
...
import com.ptwelvebreeze.features.dashboard.presentation.ReasonDialog
...
import com.ptwelvebreeze.features.document.model.AddEditDocumentInputParams
import com.ptwelvebreeze.features.document.model.DocumentAttachmentModel
...
import com.ptwelvebreeze.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.ptwelvebreeze.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.ptwelvebreeze.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.ptwelvebreeze.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.ptwelvebreeze.features.orderhistory.model.*
...
import com.ptwelvebreeze.features.quotation.model.AddQuotInputModel
import com.ptwelvebreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.ptwelvebreeze.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.ptwelvebreeze.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.ptwelvebreeze.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.ptwelvebreeze.features.stockAddCurrentStock.ShopAddCurrentStockRequest
...
import com.ptwelvebreeze.features.stockCompetetorStock.ShopAddCompetetorStockRequest
...
import com.ptwelvebreeze.features.timesheet.model.AddTimeSheetInputModel
import com.ptwelvebreeze.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.ptwelvebreeze.features.viewAllOrder.model.AddOrderInputParamsModel
import com.ptwelvebreeze.features.viewAllOrder.model.AddOrderInputProductList
import com.ptwelvebreeze.mappackage.SendBrod
import com.ptwelvebreeze.widgets.AppCustomTextView
import com.ptwelvebreeze.MonitorService
import com.ptwelvebreeze.MySingleton
...
import com.ptwelvebreeze.features.addshop.presentation.ShopExtraContactReq
...
import com.ptwelvebreeze.features.login.model.GetConcurrentUserResponse
import com.ptwelvebreeze.features.login.model.WhatsappApiData
import com.ptwelvebreeze.features.orderITC.SyncOrd
import com.ptwelvebreeze.features.orderITC.SyncOrdProductL
import com.ptwelvebreeze.features.performance.model.Gps_status_list
import com.ptwelvebreeze.features.performance.model.UpdateGpsInputListParamsModel
import com.ptwelvebreeze.features.returnsOrder.ReturnProductList
import com.ptwelvebreeze.features.returnsOrder.ReturnRequest
import com.ptwelvebreeze.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xptwelvebreezelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xptwelvebreezelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xptwelvebreezelogsample/log.zip").path);
